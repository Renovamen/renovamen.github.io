<template>
  ...
  >
    <path
      ...
      style="fill: none; stroke-width: 9.89px"
    />
    <path
      d="m151.971 131.071-127.006 1.011"
      style="fill: none; stroke-width: 9.37px"
    />
    <path
...
const color = computed(() => (isDark.value ? "#ff6562" : "#e1190e"));
</script>
