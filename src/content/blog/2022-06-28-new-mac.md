...
Apple launched its back-to-school sale recently, so I upgraded from a 2015 13" MacBook Pro to a 2021 14" MacBook Pro. Though the new one does not look as attractive as the old one to me, the 14" MBP is still perfect in almost every way.

Anyway, I am trying to write a software checklist for setting up my new laptop.
...
- [Paperlib](https://paperlib.app/en/) is a new academic paper management tool
  ...
  - Pros
    ...
    - Its metadata scraper is tailored for computer science
